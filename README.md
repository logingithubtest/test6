...
![Build](https://github.com/logingithubtest/test6/workflows/Pre%20Merge%20Checks/badge.svg)
...
- [ ] Choose a [LICENSE](https://github.com/logingithubtest/test6/community/license/new?branch=master).
- [ ] Set your `ORG_GRADLE_PROJECT_NEXUS_USERNAME`, `ORG_GRADLE_PROJECT_NEXUS_PASSWORD`, `ORG_GRADLE_PROJECT_SIGNING_KEY` and `ORG_GRADLE_PROJECT_SIGNING_PWD` secrets in [Settings](https://github.com/logingithubtest/test6/settings/secrets/actions).
